...
free solution; but in $47.2$ seconds with UCS and in $190.7$ seconds
with DP running on an iCore9. We explored the graph with a depth of
24. UCS has a complexity of $\mathcal{O}(n\log n)$ with $n=\left|\text{states}\right|$.
